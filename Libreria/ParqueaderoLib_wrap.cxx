...
#define SWIG_name    "_ParqueaderoLib"
/* -----------------------------------------------------------------------------
...
/*-----------------------------------------------
              @(target):= _ParqueaderoLib.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ParqueaderoLib

#else
#  define SWIG_init    init_ParqueaderoLib
...
SWIGINTERN PyObject *_wrap_Parqueadero_procesarPlaca(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "Parqueadero_procesarPlaca", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Parqueadero, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Parqueadero_procesarPlaca" "', argument " "1"" of type '" "Parqueadero *""'"); 
  }
  arg1 = reinterpret_cast< Parqueadero * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "Parqueadero_procesarPlaca" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = (arg1)->procesarPlaca(SWIG_STD_MOVE(arg2));
...
SWIGINTERN PyObject *_wrap_Parqueadero_obtenerUltimoEvento(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Parqueadero *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Parqueadero, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Parqueadero_obtenerUltimoEvento" "', argument " "1"" of type '" "Parqueadero *""'"); 
  }
  arg1 = reinterpret_cast< Parqueadero * >(argp1);
  result = (arg1)->obtenerUltimoEvento();
  resultobj = SWIG_From_std_string(static_cast< std::string >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_Parqueadero(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Parqueadero *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_Parqueadero, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Parqueadero" "', argument " "1"" of type '" "Parqueadero *""'"); 
  }
  arg1 = reinterpret_cast< Parqueadero * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *Parqueadero_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_Parqueadero, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *Parqueadero_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
