...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_guardarEvento(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "guardarEvento" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  guardarEvento((char const *)arg1);
...
SWIGINTERN PyObject *_wrap_obtenerEvento(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  char *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "obtenerEvento", 0, 0, 0)) SWIG_fail;
  result = (char *)obtenerEvento();
...
static PyMethodDef SwigMethods[] = {
	 { "guardarEvento", _wrap_guardarEvento, METH_O, NULL},
	 { "obtenerEvento", _wrap_obtenerEvento, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
